                ...
                <div class="widget-content widget-content-area">
                        ...
                        <div class="col-12 col-sm-6 d-flex justify-content-sm-start justify-content-center">
                            <div class="btn-group  mb-2 me-4" role="group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btndefault6">
                                    <a href="{{$manufacturers->getOptions()['path']}}?perPage=10" class="dropdown-item"><i class="flaticon-home-fill-1 mr-1"></i>10</a>
                                    <a href="{{$manufacturers->getOptions()['path']}}?perPage=25" class="dropdown-item"><i class="flaticon-gear-fill mr-1"></i>25</a>
                                    <a href="{{$manufacturers->getOptions()['path']}}?perPage=50" class="dropdown-item"><i class="flaticon-bell-fill-2 mr-1"></i>50</a>
                                    <a href="{{$manufacturers->getOptions()['path']}}?perPage=100" class="dropdown-item"><i class="flaticon-dots mr-1"></i>100</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="post-pagination">
                        <div class="pagination-no_spacing">
                            <ul class="pagination">
                                <li><a href="{{ $manufacturers->previousPageUrl() }}" class="prev"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-left"><polyline points="15 18 9 12 15 6"></polyline></svg></a></li>
                                <li><a href="{{ $manufacturers->previousPageUrl() }}">{{ $manufacturers->currentPage() - 1}}</a></li>
                                <li><a href="javascript:void(0);" disabled class="active">{{$manufacturers->currentPage()}}</a></li>
                                <li><a href="{{ $manufacturers->nextPageUrl() }}">{{ $manufacturers->currentPage() + 1}}</a></li>
                                <li><a href="{{ $manufacturers->nextPageUrl() }}" class="next"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
