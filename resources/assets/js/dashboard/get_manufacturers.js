document.addEventListener("DOMContentLoaded", () => {
    document
        .getElementById("getManufacturers")
        .addEventListener("click", getManufacturersErp);
    document
        .getElementById("sendManufacturers")
        .addEventListener("click", sendManufacturersStore);
